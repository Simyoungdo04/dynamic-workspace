package dev.yd.web.member.model.dto;
...
public class MemberDto {
	...
	public MemberDto(Long userNo, String userId, String userPwd, String userName, String email, String profileImg,
	...
	public String toString() {
		return "MemberDto [userNo=" + userNo + ", userId=" + userId + ", userPwd=" + userPwd + ", userName=" + userName
				+ ", email=" + email + ", profileImg=" + profileImg + ", enrollDate=" + enrollDate + ", modifyDate="
