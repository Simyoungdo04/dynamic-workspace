...
<body>
    <div class="wrap">
        ...
        <div class="content">
            <br><br>
            <form action="http://localhost:8088/subway/order.do" method="post">
                ...
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            <th>요청사항</th>
                            <td><textarea name="require" cols="80" rows="5" class="form-control" style="resize:none"></textarea></td>
                        </tr>
                    </table>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            <th>채소</th>
                            <td>
                                <input type="checkbox" name="sub" value="오이" checked><label>오이</label>
                                <input type="checkbox" name="sub" value="양배추" checked>양배추
                                <input type="checkbox" name="sub" value="올리브" checked>올리브
                                <input type="checkbox" name="sub" value="할라피뇨" checked>할라피뇨
                                <input type="checkbox" name="sub" value="적양파" checked>적양파
                                <input type="checkbox" name="sub" value="피망" checked>피망
                                <input type="checkbox" name="sub" value="토마토" checked>토마토
                            </td>
                        </tr>
                        <tr>
                            <th>소스</th>
                            <td>
                                <input type="checkbox" name="source" value="랜치">랜치
                                <input type="checkbox" name="source" value="후추">후추
                                <input type="checkbox" name="source" value="스위트 어니언">스위트 어니언
                                <input type="checkbox" name="source" value="스위트 칠리">스위트 칠리
                                <input type="checkbox" name="source" value="핫칠리">핫 칠리
                                <input type="checkbox" name="source" value="마요네즈">마요네즈
                                <input type="checkbox" name="source" value="홀스래디쉬">홀스래디쉬
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <input type="checkbox" name="source2" value="스모크 바비큐">스모크 바비큐
                                <input type="checkbox" name="source2" value="허니 머스타드">허니 머스타드
                                <input type="checkbox" name="source2" value="사우스웨스트 치폴레">사우스웨스트 치폴레
                                <input type="checkbox" name="cource2" value="이탈리안 드레싱">이탈리안 드레싱
                            </td>
                        </tr>
                        <tr>
                            <th>쿠키</th>
                        ...
                        <tr>
                            <th>결제방식</th>
                            <td>
                                <input type="radio" name="pay" value="card" checked> 카드결제
                                <input type="radio" name="pay" value="cash"> 현금결제
                            </td>
                        </tr>
                    </table>	
                </fieldset>
                ...
                <hr>
                <div id="btn-zone">
                    <input onclick="order();" name="" type="submit" class="btn btn-info" value="주문하기">
	...
	<a href='http://localhost:8088/subway/order-list.do'>주문내역보기</a>
